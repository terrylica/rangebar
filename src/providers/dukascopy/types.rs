//! Dukascopy data types and error handling
//!
//! Core data structures for Dukascopy tick data, enhanced range bars, and
//! comprehensive error types with recovery policies.
