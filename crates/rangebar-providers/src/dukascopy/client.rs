...
///
/// ```
/// use rangebar_providers::dukascopy::client::get_instrument_info;
/// use rangebar_providers::dukascopy::types::InstrumentType;
///
...
impl DukascopyFetcher {
    ...
    ///
    /// ```rust,no_run
    /// use rangebar_providers::dukascopy::client::DukascopyFetcher;
    ///
